...
CommunityListEntry = collections.namedtuple("CommunityListEntry", "community action comment")
"""
...
ExtCommunityListEntry = collections.namedtuple("ExtCommunityListEntry", "community action type")
"""
