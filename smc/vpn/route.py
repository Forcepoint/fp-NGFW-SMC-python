...
class RouteVPN(Element):
    ...
    @classmethod
    def _create_ipsec_tunnel_65(cls, name, local_endpoint, remote_endpoint,
    ...
    @classmethod
    def _create_ipsec_tunnel_66(cls, name, local_endpoint, remote_endpoint,
                                 preshared_key=None, monitoring_group=None,
                                 vpn_profile=None, mtu=0, pmtu_discovery=True,
                                 ttl=0, enabled=True, comment=None):
    ...
    @classmethod
    def _create_gre_transport_mode_65(cls, name, local_endpoint, remote_endpoint,
    ...
    @classmethod
    def _create_gre_transport_mode_66(cls, name, local_endpoint, remote_endpoint,
                             preshared_key, monitoring_group=None,
                             vpn_profile=None, mtu=0, ttl=0,
                             pmtu_discovery=True, enabled=True, comment=None):
        group = monitoring_group or TunnelMonitoringGroup('Uncategorized')
